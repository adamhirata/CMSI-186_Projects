 ...
 * Notes      :  Adam Hirata remove addbyte method from the tester, because his BrobInt program only uses
 *               integger array to add
 * Warnings   :  None
 *
 *  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * Revision History
...
public class BrobIntTester {
   ...
   public static void main( String[] args ) {
      ...
      try {
         System.out.println( "    Test 016/017: Adding g11 and g13 [10 + 234567] using ints: " );
         System.out.println( "      expecting: 234577 and got " + g11.add( g13 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }
      
      try {
         System.out.println( "    Test 018/019: Adding g13 and g11 [234567 + 10] using ints: " );
      ...
      try {
         System.out.println( "    Test 022/023: Adding g14 and g15 [-234567 + -10] using ints: " );
         System.out.println( "      expecting: -234577 and got " + g14.add( g15 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }

      try {
         System.out.println( "    Test 024/025: Adding g15 and g14 [-10 + -234567] using ints: " );
      ...
      try {
         System.out.println( "    Test 027/028: Adding g14 and g16 [-234567 + -999999] using ints: " );
         System.out.println( "      expecting: -1234566 and got " + g14.add( g16 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }

      try {
         System.out.println( "    Test 029/030: Adding g16 and g14 [-999999 + -234567] using ints: " );
         System.out.println( "      expecting: -1234566 and got " + g16.add( g14 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }

      try {
         System.out.println( "\n      Test 031/032: Adding g4 and g1 using ints: " );
